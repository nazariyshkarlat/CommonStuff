...
public class CircularProgressBar extends View {
    ...
    private int mStrokeWidth = NumberExtensionsKt.dpToPx(6);      // Width of outline
    private long mAnimationDuration = Const.TIMEOUT;       // Animation duration for progress change
    ...
    private int mProgressColor = Color.parseColor("#60AEEB");   // Outline color
    private int mProgressBackgroundColor = Color.parseColor("#F3F3F3");   // Background color
